...
class TeiTest < Minitest::Test
    ...
    def test_teifacsimile_page
        ...
        assert_match '{% raw %}RS{% endraw %}', html,
    ...
    def test_teizone
        ...
        # css styles should match what is generated by the xslt
        # adjust percentage output to match xslt format-number
        test_css = css.gsub(/(\.\d)0%/, '\1%')
        assert_match test_css, page.html()
        ...
        # annotation data should be in the html output
        assert_match annotation_data, teidoc.pages[7].html()
